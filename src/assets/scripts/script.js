...
checkscroll(scroll)
if ($(window).width() < 967) {
   search.find('img').attr('src', 'assets/images/header/search-white.png')
}
...
function checkscroll(scroll) {
   if (scroll > 0) {
      ...
      if ($(this).width() > 967) {
         search.find('img').attr('src', 'assets/images/header/search.png')
      }
   }
}
...
$(servicesCol).on('mouseover', function () {
   $.each($(this), function () {
      $(this).find('img').attr('src', 'assets/images/services/telephone-white.png')
   })
})
$(servicesCol).on('mouseout', function () {
   $.each($(this), function () {
      $(this).find('img').attr('src', 'assets/images/services/telephone.png')
   })
})
